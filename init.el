...
(add-to-list 'package-archives '("stablemelpa" . "https://stable.melpa.org/packages/") t)
...
;;(load (expand-file-name "custom/ivy-settings.el"
;;user-emacs-directory))

;; loading completion related settings
(load (expand-file-name "custom/completion.el" user-emacs-directory))
...
;; loading yasnippet
(load (expand-file-name "custom/snippet.el" user-emacs-directory))
